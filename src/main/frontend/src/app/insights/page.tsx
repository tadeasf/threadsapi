    ...
    const fetchInsightsData = async () => {
        ...
        try {
            ...
            const [dashboardRes, performanceRes, trendsRes] = await Promise.all([
                fetch(`${API_BASE_URL}/api/insights/dashboard/${userId}`),
                fetch(`${API_BASE_URL}/api/insights/performance/${userId}?days=${selectedPeriod}`),
                fetch(`${API_BASE_URL}/api/insights/trends/${userId}?days=${selectedPeriod}`)
            ])
